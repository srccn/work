...
class UserExtranetHelperAlerts
{
	static function getStateOptions() {
		// Build the filter options.
		$options	= array();
		$options[]	= JHtml::_('select.option',	1,	JText::_('COM_USEREXTRANET_ENABLED'));
		$options[]	= JHtml::_('select.option',	0,	JText::_('COM_USEREXTRANET_DISABLED'));
		return $options;
	}
