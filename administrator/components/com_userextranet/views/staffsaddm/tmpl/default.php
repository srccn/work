...
<?php endif;?>
	...
	<table class="table table-striped" id="ueStaffsaddm">
		<thead>
			<tr>
				<th width="1%">
		...
		<input type="hidden" name="noteid" value="12" />
