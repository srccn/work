...
class UserExtranetModelManagepermissions extends JModelList
{
	...
	protected function getListQuery() {
		...
		// Join over the extranet users.
		$query->select('eu.id AS eid');
		$query->join('LEFT', '#__ue_users AS eu ON eu.user_id=u.id');
