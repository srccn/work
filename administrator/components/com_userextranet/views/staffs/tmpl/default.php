...
<?php endif;?>
	...
	<table class="table table-striped" id="ueStaffs">
		<thead>
			<tr>
				<th width="1%">
					<input type="checkbox" name="checkall-toggle" value="" title="<?php echo JText::_('JGLOBAL_CHECK_ALL'); ?>" onclick="Joomla.checkAll(this)" />
				</th>
				<th width="79%" class="title" align="left" style="text-align: left;">
					<?php echo JHtml::_('grid.sort',  'COM_USEREXTRANET_NAME', 'u.name', $listDirn, $listOrder); ?>
				</th>
				<th width="12%" align="center" style="text-align: center;">
					<?php echo JHtml::_('grid.sort',  'COM_USEREXTRANET_CREATED_DATE', 's.created_date', $listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		<tfoot>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php endif; ?>
					<?php if ($canEdit && $this->ueACL->can('staff.view') && $this->ueACL->can('staff.edit')) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_userextranet&task=staff.edit&id='.(int) $item->id); ?>">
		...
		<input type="hidden" name="noteid" value="10" />
